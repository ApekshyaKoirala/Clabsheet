...
int main()
{
    ...
    else if(key==1)
    {
        ...
        else if(ans17==2||ans17==3||ans17==4)
        {
            printf("Your answer is incorrect\n");
            printf("The correct answer is 1\n");
        }
        ...
        else if(ans18==2||ans18==3||ans18==4)
        {
            printf("Your answer is incorrect\n");
            printf("The correct answer is 1\n");
        }
        ...
        else if(ans19==2||ans19==3||ans19==4)
        {
            printf("Your answer is incorrect\n");
            printf("The correct answer is 1\n");
        }
        ...
        else if(ans20==2||ans20==3||ans20==4)
        {
            printf("Your answer is incorrect\n");
            printf("The correct answer is 1\n");
        }
        ...
        {
        printf("\n%s,You have scored %d points",name,count);
        }
        printf("Incorrect answer=%d",20-count);
    }
    return 0;
}